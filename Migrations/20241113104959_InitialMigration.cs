    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserGameRecords", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserHighscores", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserHighscores_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserGameRecords_UserId",
                table: "UserGameRecords",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserHighscores_UserId",
                table: "UserHighscores",
                column: "UserId");
